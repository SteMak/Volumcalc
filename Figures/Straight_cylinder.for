      SUBROUTINE CALC_STRAIGHT_CYLINDER(MEASURE)
        CHARACTER*80 MEASURE
        CHARACTER*80 A, B
        A = '1'
        B = '1'
        CALL CALC_STRAIGHT_CYLINDER_MENU(MEASURE, A, B)
      END
      
      SUBROUTINE CALC_STRAIGHT_CYLINDER_MENU(MEASURE, A, B)
     ...
     +    '(2) Set height ', VB(1:31)
        ...
        CALL WRITE_SPACE(4)
        PRINT '(A, A, E15.8, A, A)', '                  ',
     +    '     VOLUME =', CHTOIN(A)**2*CHTOIN(B)*3.1415926,
